...
export class Backend implements backendInterface {
    ...
    async addApp(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
    ...
    async closeApp(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.closeApp();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAppUsage(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getAppUsage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOpenApp(): Promise<bigint | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getOpenApp();
    ...
    async openAppById(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.openAppById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePreferences(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePreferences(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
